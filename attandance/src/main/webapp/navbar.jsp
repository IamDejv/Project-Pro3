...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/src/main/webapp/css/bootstrap.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/src/main/webapp/css/layout.css">
</head>
<body>
