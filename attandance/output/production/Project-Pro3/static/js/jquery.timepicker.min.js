    ...
    !function () {
        ...
        a.TimePicker = function () {
            ...
            keyCode: {
                ...
                var d = this, e = b === !1 ? d.instance : b;
                d.setTime(e, a.fn.timepicker.parseTime(c.children("a").text())), d.close(e, !0)
            }, activate: function (a, b) {
                var c = this, d = a === !1 ? c.instance : a;
                if (d === c.instance) {
                    if (c.deactivate(), c._hasScroll()) {
                        var e = b.offset().top - c.ui.offset().top, f = c.ui.scrollTop(), g = c.ui.height();
                ...
                var d = this, e = b.getTime(), f = b.options.dynamic && e;
                ...
                return d.ui.css({width: j}), d.viewport.css({width: j}), b.items.css({width: j}), d.instance = b, e ? b.items.each(function () {
                    var c, f = a(this);
                ...
                var c = this, d = a.fn.timepicker.parseTime(b.element.val());
        ...
        }, a.TimePicker.methods = {chainable: ["next", "previous", "open", "close", "destroy", "setTime"]}, a.fn.timepicker = function (b) {
            if ("string" == typeof b) {
                ...
                return c = "option" === b && arguments.length > 2 ? "each" : -1 !== a.inArray(b, a.TimePicker.methods.chainable) ? "each" : "map", d = this[c](function () {
                    var c = a(this), d = c.data("TimePicker");
            ...
            var d = c.getHours(), e = d % 12, f = c.getMinutes(), g = c.getSeconds(), h = {
